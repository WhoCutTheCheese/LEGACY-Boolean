...
module.exports = {
    ...
    callback: async (client, bot, message, args, text) => {
        ...
        let findinserver = message.mentions.members.first() || message.guild.members.cache.find(m => m.id === args[0])
        if (!args[0]) {
        ...
        if (findinserver) {
            ...
            const userInfoAuthor = new MessageEmbed()
                ...
                .addField('🗓️ Account joined:', `N/A`, true)
